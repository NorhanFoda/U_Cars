                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @can('admin-only', auth()->user())
                                                            ...
                                                            <a href="/public/sub_services/{{$sub_service->id}}/colors" type="button" class="btn  btn-primary"><i class="fas fa-users"></i> عرض الوان الخدمه</a>
                                                            <button
                                                                type="button" 
                                                                class="btn btn-warning add-item"
                                                                value="{{$sub_service->id}}"
                                                                data-toggle="modal" 
                                                                data-target="#addColorModal"><i class="fas fa-plus"></i>اضافة لون 
                                                            </button>
                                                        @endcan
                                                        <!-- Modal -->
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form class="services-form" action="{{route('colors.store', $sub_service->id)}}" method="POST" enctype="multipart/form-data">
                                                                            {{ csrf_field() }}
                                                                            <input type="hidden" class="form-control" id="input_id" name="id">
...
<script type="text/javascript">
    ...
    $(document).on('click','.add-item',function(){
        ...
        $.get(url + '/' + subService_id, function (data) {
            //success data
            console.log(data);
